...
logging.basicConfig(level=logging.DEBUG,
                    ...
                    filename='E:/Git/WebdriverTest/logs/WebdriverTest_%s.log'%time,
                    filemode='a+')
...
# 设置日志打印格式
formatter = logging.Formatter("[%(levelname)s] [%(module)s] [%(funcName)s] [line %(lineno)s] [%(asctime)s] %(message)s")
